    ...
    return (
        sortedBoxScore.map(player => (
            ...
            (player.slot_position !== "BE" && player.slot_position !== "IR" ?
                ...
                <div className="flex flex-row text-center text-sm text-base sm:text-base md:text-base lg:text-base justify-between truncate"> 
                    ...
                    <div className='flex flex-col justify-end text-right overflow-x-hidden'>
                        ...
                        <div className="justify-end bg-green-400 px-1 rounded w-fit justify-end" style={{"marginLeft":"auto"}}>
                            <div className="flex flex-row gap-1 ml-a" >
                                <span className='text-xs font-light truncate'>{player.position} • {player.proTeam}</span>
                ...
                <div className="flex flex-row text-center text-base text-sm sm:text-base md:text-base lg:text-base justify-between"> 
