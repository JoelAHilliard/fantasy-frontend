    ...
    return(
        ...
        <div className="p-4">
          ...
          <div className="relative w-full mt-4 mb-4 overflow-hidden">
            <div className="flex overflow-x-auto no-scrollbar gap-4 p-2 pr-8 pl-6">
                <Hoff className="flex-none min-w-22 overflow-visible bg-white p-4 rounded-md shadow-lg"></Hoff>
            ...
            <div className="absolute top-0 bottom-0 left-0 pointer-events-none">
                <div className="h-full w-12 bg-gradient-to-r from-white to-transparent"></div>
            </div>
